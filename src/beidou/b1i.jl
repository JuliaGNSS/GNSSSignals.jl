...
# The only open-service component on the 1561.098 MHz carrier (the B1Q counterpart
# is not in the OS ICD), so it is its own composite. See [`get_relative_power`](@ref).
@inline get_relative_power(::Type{<:BeiDouB1I}) = 1.0
...
```
"""
@inline get_signal_name(::Type{<:BeiDouB1I}) = "BeiDou B1I"
