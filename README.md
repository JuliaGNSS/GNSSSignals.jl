...
* Galileo E5a-QP (BPSK(5) quasi-pilot, 330-chip short acquisition code, 40 PRNs)
* Galileo E5b-I (BPSK(10) at 1207.14 MHz with 4-bit CS4 secondary code, I/NAV data component)
* Galileo E5b-Q (BPSK(10) pilot at 1207.14 MHz with the 100-chip per-SVID CS100 codes 51-100)
* Galileo E6-B (BPSK(5) at 1278.75 MHz, 5115-chip memory code, C/NAV data component carrying the High Accuracy Service)
* Galileo E6-C (BPSK(5) pilot at 1278.75 MHz, dataless, with the 100-chip per-SVID CS100 secondary code)
