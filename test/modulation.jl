@testset "Modulation" begin
    ...
    @test GNSSSignals.get_subcarrier_code(boc_sin, 0.0) == 1.0
    @test GNSSSignals.get_subcarrier_code(boc_sin, 0.5) == -1.0
    @test GNSSSignals.get_subcarrier_code(boc_sin, 1.0) == 1.0
    @test GNSSSignals.get_subcarrier_code(boc_sin, 1.5) == -1.0
    @test GNSSSignals.get_subcarrier_code(boc_sin, 2.0) == 1.0
